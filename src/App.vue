...
<template>
  <div
    class="h-screen w-screen bg-gray-900 text-white flex overflow-hidden font-sans"
  >
    <!-- Sidebar -->
    <aside
      class="bg-gray-800 border-r border-gray-700 flex flex-col flex-shrink-0"
      ...
      >
        ...
        >
          <div class="flex-1 flex overflow-hidden">
            ...
            >
              <TerminalTabArea
                :ref="(el: any) => { if (el) terminalTabAreaRefs[index] = el }"
                :sessionId="session.id"
              />
            </div>
          ...
          <!-- Session Status Bar -->
          <div
            class="h-8 bg-gray-800 border-t border-gray-700 text-xs flex items-center justify-between px-3"
          >
            ...
            <div class="flex-1 flex justify-end items-center space-x-4 ml-4">
              <template v-if="sessionStatus[session.id]">
                ...
                <div
                  ...
                  :title="sessionStatus[session.id].uptime"
                >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div
                        class="text-gray-300 font-medium mb-2 pb-1 border-b border-gray-600"
                      >
                        Disk Mounts ({{
                      ...
                      <div class="space-y-2">
                        <div
                          v-for="mount in sessionStatus[session.id].mounts"
                          :key="mount.mount"
                          class="border-b border-gray-700/50 pb-2 last:border-b-0"
                        >
                          <div class="flex items-center justify-between mb-1">
                            <span
                              class="text-blue-400 font-mono text-xs truncate flex-1 mr-2"
                              :title="mount.mount"
                            >
                              {{ mount.mount }}
                            </span>
                          ...
                          <div
                            class="grid grid-cols-2 gap-x-3 gap-y-0.5 text-[10px]"
                          >
                            <div class="text-gray-500">FS:</div>
                            <div
                              class="text-gray-300 font-mono truncate"
                      ...
                      <div class="absolute top-full right-4 -mt-1">
                        <div
                          class="w-2 h-2 bg-gray-800 border-r border-b border-gray-600 transform rotate-45"
                        ></div>
                      </div>
                    </div>
                  </div>
                ...
                <!-- CPU Usage -->
                <div
                  v-if="sessionStatus[session.id].cpu"
                  class="group relative flex items-center cursor-help text-gray-400 hover:text-gray-200 py-1 -my-1 px-2 -mx-2"
                >
                  <div class="flex items-center space-x-1">
                    <span>CPU:</span>
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="space-y-2">
                        <div
                          v-for="process in sessionStatus[
                            session.id
                          ].cpu?.topProcesses.slice(0, 5)"
                          :key="process.pid"
                          class="border-b border-gray-700/50 pb-2 last:border-b-0"
                        >
                          <div class="flex items-center justify-between mb-1">
                ...
                <!-- Memory Usage -->
                <div
                  v-if="sessionStatus[session.id].memory"
                  class="group relative flex items-center cursor-help text-gray-400 hover:text-gray-200 py-1 -my-1 px-2 -mx-2"
                >
                  <div class="flex items-center space-x-1">
                    <span>Mem:</span>
                ...
                <div
                  class="text-gray-400 truncate"
                  :title="sessionStatus[session.id].ip"
                >

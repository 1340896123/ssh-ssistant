...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ops::asset_export_local_workspace_snapshot,
            ops::asset_restore_local_workspace_snapshot,
            ops::asset_clear_workspace,
            ...
            ops::asset_get_access_history,
            ops::asset_import_legacy_client_state,
            ops::asset_create_saved_view,
            ops::asset_delete_saved_view,
            ops::access_get_access_endpoints,
            ops::access_create_access_endpoint,
            ops::access_update_access_endpoint,
            ops::access_delete_access_endpoint,
            ops::access_get_credential_refs,
            ops::access_create_credential_ref,
            ops::access_update_credential_ref,
            ops::access_delete_credential_ref,
            ops::session_connect_asset,
            ops::session_disconnect_asset,
            ops::session_get_ops_sessions,
            ops::ops_list_job_templates,
            ops::ops_create_job_template,
            ops::ops_delete_job_template,
            ops::ops_list_job_runs,
            ops::ops_list_job_archives,
            ops::ops_execute_job,
            ops::ops_preview_job_batch,
            ops::ops_execute_job_batch,
            ops::ops_console_query,
            ops::audit_list_events,
            ops::audit_search_events,
            ops::audit_create_event,
            ops::sync_get_state,
            ops::sync_get_overview,
            ops::sync_save_state,
            ops::sync_list_change_log,
            ops::sync_mark_changes_synced,
            ops::sync_list_services,
            ops::sync_upsert_service,
            ops::ai_plan_action,
            ...
            db::get_settings,
            db::save_settings,
            db::get_local_workspace_snapshot,
